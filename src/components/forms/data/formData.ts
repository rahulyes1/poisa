export const EXPENSE_QUICK_AMOUNTS = [50, 100, 500, 1000, 5000];
...
export const EXPENSE_CATEGORIES = [
  ...
  { emoji: "🏪", label: "Kirana", icon: "storefront" },
  { emoji: "🥙", label: "Street Food", icon: "fastfood" },
  { emoji: "🍵", label: "Chai & Coffee", icon: "coffee" },
  { emoji: "🍰", label: "Snacks", icon: "bakery_dining" },
  { emoji: "🚕", label: "Transport", icon: "directions_car" },
  { emoji: "🛺", label: "Auto & Cab", icon: "electric_rickshaw" },
  { emoji: "🚌", label: "Bus & Train", icon: "directions_bus" },
  { emoji: "🏠", label: "Bills", icon: "receipt_long" },
  { emoji: "🔌", label: "Electricity", icon: "bolt" },
  { emoji: "🛢️", label: "LPG & Gas", icon: "local_fire_department" },
  { emoji: "💧", label: "Water Bill", icon: "water_drop" },
  { emoji: "🏢", label: "Society / Maintenance", icon: "apartment" },
  { emoji: "📡", label: "Broadband & WiFi", icon: "wifi" },
  { emoji: "📱", label: "Recharge", icon: "smartphone" },
  { emoji: "📺", label: "DTH & OTT", icon: "live_tv" },
  { emoji: "🧾", label: "Utilities", icon: "receipt_long" },
  { emoji: "💊", label: "Health", icon: "medical_services" },
  { emoji: "✈️", label: "Travel", icon: "flight" },
  { emoji: "🎬", label: "Fun", icon: "movie" },
  { emoji: "🎊", label: "Function & Events", icon: "celebration" },
  ...
  { emoji: "👩‍🍳", label: "House Help", icon: "cleaning_services" },
  { emoji: "🧺", label: "Laundry", icon: "local_laundry_service" },
  { emoji: "🪔", label: "Pooja & Temple", icon: "temple_hindu" },
  { emoji: "🍺", label: "Alcohol", icon: "sports_bar" },
  { emoji: "🐶", label: "Pets", icon: "pets" },
  { emoji: "💼", label: "Work", icon: "work" },
  { emoji: "💅", label: "Parlour / Salon", icon: "spa" },
